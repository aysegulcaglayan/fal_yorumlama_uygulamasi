...
<div id="header">
  <div class="inner">
    <header>
      <h1><a href="#" id="logo">SU FALI</a></h1>
      <hr>
      <span class="byline">BERRAK GELECEK İÇİN...</span> </header>
  </div>
  <nav id="nav">
    <ul>
...
if(isset($_POST['kayit'])){
  ...
  VALUES (' ','su','$ad_soyad', '$mail', '$cinsiyet','$iliski',' $yorumcu', '$dogum_tarihi',NULL,NULL,NULL)";
