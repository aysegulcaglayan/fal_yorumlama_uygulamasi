...
<div id="header">
  <div class="inner">
    <header>
      <h1><a href="#" id="logo">YILDIZNAME FALI</a></h1>
      <hr>
      <span class="byline">GÖKYÜZÜNDEN RUHUNUZA...</span> </header>
  </div>
  <nav id="nav">
    <ul>
    ...
    <form  method="post" enctype="multipart/form-data">
        ...
        <div>
            <label for="dogum_saati">Doğum Saati:</label>
            <input type="time" name="dogum_saati" id="dogum_saati" required>
        </div>
        <div>
            <label for="anne_ismi">Anne İsmi:</label>
            <input type="text" name="anne_ismi" id="anne_ismi" required>
        </div>
...
if(isset($_POST['kayit'])){
  ...
  VALUES (' ','yildiz','$ad_soyad', '$mail', '$cinsiyet','$iliski',' $yorumcu', '$dogum_tarihi',NULL,NULL,NULL)";
