...
<div id="header">
  <div class="inner">
    <header>
      <h1><a href="#" id="logo">BİLGİLENDİRME</a></h1>
      <hr>
      <span class="byline"> Fal Sonucunuz Mail Olarak Tarafınıza İletilecektir. Bizi Tercih Ettiğiniz İçin Teşekkür Ederiz...</span> </header>
  </div>
  <nav id="nav">
    <ul>
