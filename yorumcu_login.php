...
<div id="header">
  <div class="inner">
    <header>
      <h1><a href="#" id="logo">YORUMCU GİRİŞİ</a></h1><br>
      <h3 style="color:black">Lütfen Yöneticiniz Tarafından Size Verilen Mail Adresi ve Şifre İle Giriş Yapınız</h3>
      <hr>
      <form >
    ...
    if(isset($_GET['admin_giris'])){
     ...
     if($adminmail=='falim@gmail.com' && $adminsifre=='falım123'){
        echo"Giriş Başarılı";
